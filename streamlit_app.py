    ...
    def predict(self, X):
        ...
        if isinstance(X, pd.DataFrame):
            ...
            if 'AccommodationType' in X.columns:
                ...
                base_daily_pred = base_daily_pred * acc_multipliers
     
            
            # Apply duration multiplier
        if 'Duration' in X.columns:
                total_pred = base_daily_pred * X['Duration']
                return total_pred
        
        return base_daily_pred
    ...
    if submitted:
        try:
            ...
            input_data = pd.DataFrame([{
                ...
                'Duration': 1,  # Predict for 1 day to get base rate
            ...
            st.write(f"Base daily cost: ${daily_rate:,.2f}")
